          ...
          <div className="lg:w-1/3">
              ...
              <div className="flex gap-3">
                {photo.palette.map((color, i) => (
                  <div key={i} className="text-center">
                    <div className="w-14 h-14 rounded-xl mb-1" style={{ backgroundColor: color }} />
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {photo.tags.map((tag) => (
                  <span key={tag} className="px-4 py-2 rounded-full text-sm" style={{ backgroundColor: `${categoryColor}22`, color: categoryColor, border: `1px solid ${categoryColor}44` }}>
                    {tag}
                  </span>
                ))}
              </div>
